...
const Navbar = () => {
    const [isMobilelMenuToggled, setIsMobileMenuToggled] = useState(false)
    ...
    return <FlexBetween padding="1rem 6%" backgroundColor={alt}>
        ...
        <IconButton onClick={()=>setIsMobileMenuToggled(!isMobilelMenuToggled)}>
            <Menu/>
        </IconButton>
        )}
    {/* MOBILE NAV */}
    {!isNonMobileScreens && isMobilelMenuToggled && (
        <Box
              position="fixed"
              right="0"
              bottom="0"
            ...
            <Box display="flex" justifyContent="flex-end" p="1rem">
                <IconButton onClick={()=>setIsMobileMenuToggled(!isMobilelMenuToggled)}><Close/></IconButton>
            </Box>
        {/* MENU ITEMS */}
        <FlexBetween
            display="flex"
